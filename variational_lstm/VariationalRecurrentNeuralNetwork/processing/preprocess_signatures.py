...
# return {signatures_train, signatures_test, labels_train, labels_test}
def get_dataset():
	...
	stride = 10			# How far to move the window for creating fixed-length subsequences with each signature
	length = 20			# How big each window is for the fixed-length sequences
	merge_num = 5		# How many rows to concatenate into a single row -- see function for more details
